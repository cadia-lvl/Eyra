...
const = dict(
    ...
    backend_db = 1,
    #
    session_timeout = 999999, # timeout in seconds, assume session is over, if 15 mins have passed since last query for report 
    ...
    batch_size = 500, # number of recordings to process at a time (per task)
